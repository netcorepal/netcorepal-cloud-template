...
- 领域层测试：`test/TestAdminProject.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/TestAdminProject.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/TestAdminProject.Infrastructure.Tests/{Component}Tests.cs`。
