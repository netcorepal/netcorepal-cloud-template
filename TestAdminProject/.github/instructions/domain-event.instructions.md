---
applyTo: "src/TestAdminProject.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/TestAdminProject.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/TestAdminProject.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using TestAdminProject.Domain.Aggregates.UserAggregate;

namespace TestAdminProject.Domain.DomainEvents;
