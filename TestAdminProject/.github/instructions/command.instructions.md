---
applyTo: "src/TestAdminProject.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/TestAdminProject.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/TestAdminProject.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using TestAdminProject.Domain.AggregatesModel.UserAggregate;
using TestAdminProject.Infrastructure.Repositories;

namespace TestAdminProject.Web.Application.Commands.Users;
