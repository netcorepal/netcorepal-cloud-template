---
applyTo: "src/TestAdminProject.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/TestAdminProject.Web/Application/DomainEventHandlers/` 目录下。
...
using TestAdminProject.Web.Domain.DomainEvents;
