...
namespace ABC.Template.MigrationService.Migrations.SqlServer
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Instance = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    LastLockTime = table.Column<DateTime>(type: "datetime2(7)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Added = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
