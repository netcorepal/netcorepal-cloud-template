...
/// <summary>
/// A resource that represents an OpenGauss (GaussDB compatible) container.
/// </summary>
public class OpenGaussServerResource : ContainerResource, IResourceWithConnectionString
{
    internal const string PrimaryEndpointName = "tcp";
    private const string DefaultUserName = "gaussdb";
    ...
    /// <summary>
    /// Gets the connection URI expression for the OpenGauss server.
    /// </summary>
    /// <remarks>
    /// Format: <c>opengauss://{user}:{password}@{host}:{port}</c>.
    /// </remarks>
    ...
    internal ReferenceExpression BuildUri(string? databaseName = null)
    {
        ...
        builder.AppendLiteral("opengauss://");
    ...
    {
        var builder = new ReferenceExpressionBuilder();
        builder.AppendLiteral("jdbc:opengauss://");
    ...
    /// <summary>
    /// Gets the JDBC connection string for the OpenGauss server.
    /// </summary>
    /// <remarks>
    /// <para>Format: <c>jdbc:opengauss://{host}:{port}</c>.</para>
